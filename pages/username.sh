...
echo
printf "\e[0m[\e[1;94m#\e[0m] \e[1;77mSaved:\e[0m %s.txt\n" $username
echo
exit 1
fi
...
echo
sleep 1.5
printf "\n\e[0;1;4;77mN O T E: Sacan Username\n\e[0m"
echo
read -p $'\e[0m[\e[1;96m?\e[0m] \e[1;77mInput Username:\e[0m ' username

if [[ -e $username.txt ]]; then
printf "\e[0m[\e[1;94m#\e[0m] \e[1;77mRemoving previous file:\e[0m %s.txt" $username
rm -rf $username.txt
fi
printf "\n"
printf "\e[0m[\e[1;93m*\e[0m] \e[1;77mChecking username\e[0m %s\e[0m on: \e[1;77m\n" $username
echo
